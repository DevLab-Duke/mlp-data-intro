...
country_list = [
    # Europe
    "Albania", "Armenia", "Azerbaijan", "Georgia", "Hungary", "Kosovo",
    ...
    # Asia
    "Timor Leste", "Bangladesh", "Cambodia", "India", "Indonesia",
    "Kyrgyzstan", "Malaysia", "Nepal", "Pakistan","Philippines", "Sri Lanka",
    "Uzbekistan",
    
    # Africa
    "Angola", "Benin", "Burkina Faso", "Cameroon", "DR Congo", "Ghana",
    "Kenya", "Liberia", "Malawi","Mozambique", "Namibia", "Nigeria", "Rwanda",
