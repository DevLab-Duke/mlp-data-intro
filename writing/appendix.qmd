...
Below, we provide the instructions followed by human coders to assess the bias of each source. We describe the source coding process in more detail on our github at [mlp-data-intro/source_metadata/](https://github.com/DevLab-Duke/mlp-data-intro/tree/main/source_metadata).
