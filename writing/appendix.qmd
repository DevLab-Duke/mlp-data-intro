...
# Appendix E: Descriptive Figures

These descriptive figures provide additional visualization of State of Emergency event patterns across regional groupings in the HQMARC dataset. The figures complement the validation analysis by showing the distribution and frequency of State of Emergency reporting across different geographic regions.

## State of Emergency Event Distribution by Region

![State of Emergency event distribution in East Asia and Pacific region.](event_validation/State_of_Emergency_East_Asia_and_Pacific.png){#fig-desc-soe-eap width="100%"}

![State of Emergency event distribution in Europe and Central Asia region.](event_validation/State_of_Emergency_Europe_and_Central_Asia.png){#fig-desc-soe-eca width="100%"}

![State of Emergency event distribution in Latin America and Caribbean region.](event_validation/State_of_Emergency_Latin_America_and_Caribbean.png){#fig-desc-soe-lac width="100%"}

![State of Emergency event distribution in Middle East and North Africa region.](event_validation/State_of_Emergency_Middle_East_and_North_Africa.png){#fig-desc-soe-mena width="100%"}

![State of Emergency event distribution in Sub-Saharan Africa region.](event_validation/State_of_Emergency_Sub-Saharan_Africa.png){#fig-desc-soe-ssa width="100%"}
