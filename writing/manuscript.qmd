...
This paper proceeds in three parts. In @sec-background, we discuss how *ML4P* complements existing data on regimes and opens up new avenues for research. In @sec-data, we describe the data production process. We also compare the coverage of *ML4P* to other major media repositories, showing superior accuracy and stability compared to alternatives.
